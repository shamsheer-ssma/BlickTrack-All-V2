...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Change password (authenticated users)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Verification email resent successfully' }),
