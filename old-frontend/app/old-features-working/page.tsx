...
export default function OldFeaturesWorkingPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('Features response:', featuresRes.status);
        ...
        if (featuresData.success) {
          ...
          console.log('Features set:', featuresData.data.length);
        }
        if (categoriesData.success) {
          setCategories(categoriesData.data);
          console.log('Categories set:', categoriesData.data.length);
        }
      } catch (error) {
