export default async function FeaturesAllPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="px-6 py-4">
          <h1 className="text-2xl font-bold text-gray-900">All Features Data</h1>
          <p className="text-gray-600">Complete data from your database</p>
        </div>
      </div>
