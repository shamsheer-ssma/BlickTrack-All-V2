        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-4 mt-2">
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${getSeverityColor(threatModel?.priority)}`}>
                    {threatModel?.priority} Priority
                  </span>
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(threatModel?.status)}`}>
                    {threatModel?.status}
                  </span>
            ...
            <div className="flex flex-wrap gap-2">
              {threatModel?.tags.map((tag: string, index: number) => (
                <span
                  key={index}
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {threatModel?.threats.filter((t: any) => t.status === 'Open').length}
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {threatModel?.threats.filter((t: any) => t.status === 'Mitigated').length}
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {threatModel?.threats.filter((t: any) => t.status === 'Resolved').length}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {threatModel?.threats.map((threat: any) => (
