...
import { CheckCircle, Loader2, RefreshCw, Lock } from 'lucide-react';
            ...
            <button
              ...
              onMouseEnter={(e: React.MouseEvent<HTMLButtonElement>) => {
                if (resendCooldown === 0 && !isLoading) {
                  ...
                  ((e.currentTarget.style as unknown) as { webkitTextFillColor?: string }).webkitTextFillColor = 'white';
              ...
              onMouseLeave={(e: React.MouseEvent<HTMLButtonElement>) => {
                if (resendCooldown === 0 && !isLoading) {
                  ...
                  ((e.currentTarget.style as unknown) as { webkitTextFillColor?: string }).webkitTextFillColor = 'transparent';
